...
Exemples d'utilisation: 
    -   Ajoutez le script: message.py dans votre environnement
            Exemple si dans sous-répertoire : from Cours_3N1.Theorie import message
    -   Commencez par importer script dans votre 'Python Console': import message
